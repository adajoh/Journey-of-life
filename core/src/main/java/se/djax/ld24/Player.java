...
/* Decompiler 47ms, total 362ms, lines 140 */
...
public class Player extends Entity {
	TextureRegion[] spritesheet = new TextureRegion[3];
	int currentFrame = 0;
	...
	public void update(float rawDeltaTime) {
		...
		this.handleAnimation(rawDeltaTime);
	}
	...
	private void handleAnimation(float rawDeltaTime) {
		...
		if (this.goingRight && this.isFlipped()) {
	...
	private boolean isFlipped() {
		return this.spritesheet[this.currentFrame].getRegionWidth() < 0;
	}
